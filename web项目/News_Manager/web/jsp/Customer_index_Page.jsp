...
<div class="body">
    <div class="top_body">
        <div style="background-color: aqua">
            <p>欢迎尊敬的：${sessionScope.userInfo.username} 会员光临！&nbsp;&nbsp;&nbsp;<a href="../html/login.html" >login out</a> </p>
        </div>
        <div >
    ...
    <div class="left_body">
        <div class="news_list" id="news_list_1">
            ...
            <ul id="list_1" class="left_body_list">
                <%
                    try {
        ...
        <div class="news_list" id="news_list_2">
            ...
            <ul id="list_2" class="left_body_list">
                <%
                    try {
